            ...
            {orders.map(order => (
              order.cartItems.map((item, index) => (
                <tr key={`${order.id}-${index}`} className="bg-white">
                  ...
                  <td className="px-4 py-2 border border-gray-200">{item.furniture.furnitureName}</td>
                  <td className="px-4 py-2 border border-gray-200">{item.quantity}</td>
                  <td className="px-4 py-2 border border-gray-200">${item.furniture.price.toFixed(2)}</td>
                  <td className="px-4 py-2 border border-gray-200">${(item.furniture.price * item.quantity).toFixed(2)}</td>
                </tr>
              ))
            ))}
          </tbody>
