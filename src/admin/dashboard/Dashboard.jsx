...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [furnitureRes, ordersRes, customersRes, contactsRes] = await Promise.all([
          axios.get('http://localhost:8080/furniture/count'), // Get total furniture count
    ...
    <>
      ...
      <div className='m-4'>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <CardDataStats title="Total Furniture" total={data.totalFurniture} />
